...
1. Tour an FTC Android Studio project and run an OpMode.
2. Find configured devices through `hardwareMap`.
3. Use telemetry to observe what the program knows.
4. Command and safely stop a DC motor.
5. Move a servo within approved mechanical limits.
