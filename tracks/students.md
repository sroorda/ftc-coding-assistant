...
2. make the first change without AI;
3. use only the prompt type assigned by the lesson;
4. inspect each proposed change before accepting it;
5. run the lesson command; and
